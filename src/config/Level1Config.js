...
export default {
    ...
    movingPlatforms: [
        { x: 3220, y: 500, width: 96, speed: 45 },  // First platform (slowest)
        { x: 3340, y: 480, width: 96, speed: 50 },  // Second platform (medium speed)
        { x: 3460, y: 500, width: 96, speed: 55 }   // Third platform (fastest)
    ],
