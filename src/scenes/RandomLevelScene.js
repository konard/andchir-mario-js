...
export default class RandomLevelScene extends Phaser.Scene {
    ...
    create() {
        ...
        const playerScore = this.registry.get('playerScore') || 0;
        const playerLives = this.registry.get('playerLives') || 3;
        const playerCoins = this.registry.get('playerCoins') || 0;
        const playerIsPoweredUp = this.registry.get('playerIsPoweredUp') || false;
    ...
    createGoal() {
        // Create a flag pole as the goal
        this.goal = this.add.rectangle(
            this.levelConfig.goal.x,
            this.levelConfig.goal.y,
            32,
            200,
            0xff0000,
            0.5
